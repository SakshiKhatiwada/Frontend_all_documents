...
function moveSnake() {
  ...
  // move body
  // snake movement
  // new coordinates of snakeBody[3] should be of snakeBody[2]
  // new coordinates of snakeBody[2] should be of snakeBody[1]
  // new coordinates of snakeBody[1] should be of snakeBody[0]
...
function UpdateBoard() {
  ...
  html += `<div class="head" style="grid-area: ${snakeHead.y}/${snakeHead.x}"></div>`;
